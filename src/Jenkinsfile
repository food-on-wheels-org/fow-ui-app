    ...
    stages {
        ...
        stage('Docker Build and Push') {
            steps {
                ...
                sh 'docker build -t tejassrivathsa/fow-app-ui:${VERSION} .'
                sh 'docker push tejassrivathsa/fow-app-ui:${VERSION}'
            }
        }
        ...
        stage('Update Image Tag in GitOps') {
            steps {
                ...
                script {
                    sh '''
                        sed -i "s/image:.*/image: tejassrivathsa\\/fow-app-ui:${VERSION}/" k8s/apps/angular-manifest.yml
                    '''
